...
unless(defined(&_ASM_UNISTD_OABI_H)) {
    eval 'sub _ASM_UNISTD_OABI_H () {1;}' unless defined(&_ASM_UNISTD_OABI_H);
    ...
    eval 'sub __NR_epoll_pwait2 () {( &__NR_SYSCALL_BASE + 441);}' unless defined(&__NR_epoll_pwait2);
    eval 'sub __NR_mount_setattr () {( &__NR_SYSCALL_BASE + 442);}' unless defined(&__NR_mount_setattr);
    eval 'sub __NR_quotactl_fd () {( &__NR_SYSCALL_BASE + 443);}' unless defined(&__NR_quotactl_fd);
    eval 'sub __NR_landlock_create_ruleset () {( &__NR_SYSCALL_BASE + 444);}' unless defined(&__NR_landlock_create_ruleset);
    eval 'sub __NR_landlock_add_rule () {( &__NR_SYSCALL_BASE + 445);}' unless defined(&__NR_landlock_add_rule);
    eval 'sub __NR_landlock_restrict_self () {( &__NR_SYSCALL_BASE + 446);}' unless defined(&__NR_landlock_restrict_self);
    eval 'sub __NR_process_mrelease () {( &__NR_SYSCALL_BASE + 448);}' unless defined(&__NR_process_mrelease);
    eval 'sub __NR_futex_waitv () {( &__NR_SYSCALL_BASE + 449);}' unless defined(&__NR_futex_waitv);
    eval 'sub __NR_set_mempolicy_home_node () {( &__NR_SYSCALL_BASE + 450);}' unless defined(&__NR_set_mempolicy_home_node);
}
1;
