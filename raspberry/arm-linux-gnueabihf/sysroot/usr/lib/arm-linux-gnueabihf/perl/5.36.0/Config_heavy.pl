...
cccdlflags='-fPIC'
ccdlflags='-Wl,-E'
ccflags='-D_REENTRANT -D_GNU_SOURCE -DDEBIAN -fwrapv -fno-strict-aliasing -pipe -fstack-protector-strong -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_FORTIFY_SOURCE=2'
...
incpath=''
incpth='/usr/lib/gcc/arm-linux-gnueabihf/12/include /usr/include/arm-linux-gnueabihf /usr/include'
inews=''
...
lddlflags='-shared  -fstack-protector-strong'
...
libspath=' /usr/lib/arm-linux-gnueabihf /usr/lib /lib/arm-linux-gnueabihf /lib'
...
ccflags_nolargefiles='-D_REENTRANT -D_GNU_SOURCE -DDEBIAN -fwrapv -fno-strict-aliasing -pipe -fstack-protector-strong  -D_FORTIFY_SOURCE=2'
