...
enum opt_code
{
  ...
  OPT_Wpedantic_cast = 700,                  /* -Wpedantic-cast */
  OPT_Wpedantic_param_names = 701,           /* -Wpedantic-param-names */
  ...
  OPT_Wverbose_unbounded = 828,              /* -Wverbose-unbounded */
  ...
  OPT_fcpp = 1013,                           /* -fcpp */
  OPT_fcppbegin = 1014,                      /* -fcppbegin */
  OPT_fcppend = 1015,                        /* -fcppend */
  OPT_fcppprog_ = 1016,                      /* -fcppprog= */
  ...
  OPT_fdebug_builtins = 1033,                /* -fdebug-builtins */
  OPT_fdebug_cpp = 1034,                     /* -fdebug-cpp */
  OPT_fdebug_function_line_numbers = 1035,   /* -fdebug-function-line-numbers */
  OPT_fdebug_prefix_map_ = 1036,             /* -fdebug-prefix-map= */
  OPT_fdebug_trace_api = 1037,               /* -fdebug-trace-api */
  OPT_fdebug_trace_quad = 1038,              /* -fdebug-trace-quad */
  ...
  OPT_fdump_system_exports = 1127,           /* -fdump-system-exports */
  ...
  OPT_fextended_opaque = 1150,               /* -fextended-opaque */
  OPT_fextern_std_ = 1151,                   /* -fextern-std= */
  OPT_fextern_tls_init = 1152,               /* -fextern-tls-init */
  OPT_fexternal_blas = 1153,                 /* -fexternal-blas */
  OPT_fexternal_templates = 1154,            /* -fexternal-templates */
  OPT_ff2c = 1155,                           /* -ff2c */
  OPT_ffast_math = 1156,                     /* -ffast-math */
  OPT_ffat_lto_objects = 1157,               /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 1158,              /* -ffile-prefix-map= */
  OPT_ffinite_loops = 1159,                  /* -ffinite-loops */
  OPT_ffinite_math_only = 1160,              /* -ffinite-math-only */
  OPT_ffixed_ = 1161,                        /* -ffixed- */
  OPT_ffixed_form = 1162,                    /* -ffixed-form */
  OPT_ffixed_line_length_ = 1163,            /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 1164,        /* -ffixed-line-length-none */
  OPT_ffloat_store = 1165,                   /* -ffloat-store */
  OPT_ffloatvalue = 1166,                    /* -ffloatvalue */
  ...
  OPT_fm2_g = 1332,                          /* -fm2-g */
  OPT_fm2_lower_case = 1333,                 /* -fm2-lower-case */
  OPT_fm2_plugin = 1334,                     /* -fm2-plugin */
  OPT_fm2_statistics = 1335,                 /* -fm2-statistics */
  OPT_fm2_strict_type = 1336,                /* -fm2-strict-type */
  OPT_fm2_version = 1337,                    /* -fm2-version */
  OPT_fm2_whole_program = 1338,              /* -fm2-whole-program */
  OPT_fmacro_prefix_map_ = 1339,             /* -fmacro-prefix-map= */
  OPT_fmain = 1340,                          /* -fmain */
  OPT_fmakeinit = 1341,                      /* -fmakeinit */
  OPT_fmakelist = 1342,                      /* -fmakelist */
  ...
  OPT_fmod_ = 1356,                          /* -fmod= */
  OPT_fmodule_file_ = 1357,                  /* -fmodule-file= */
  OPT_fmodule_header = 1358,                 /* -fmodule-header */
  OPT_fmodule_header_ = 1359,                /* -fmodule-header= */
  OPT_fmodule_implicit_inline = 1360,        /* -fmodule-implicit-inline */
  OPT_fmodule_lazy = 1361,                   /* -fmodule-lazy */
  OPT_fmodule_mapper_ = 1362,                /* -fmodule-mapper= */
  OPT_fmodule_only = 1363,                   /* -fmodule-only */
  OPT_fmodule_private = 1364,                /* -fmodule-private */
  OPT_fmodule_version_ignore = 1365,         /* -fmodule-version-ignore */
  OPT_fmoduleinfo = 1366,                    /* -fmoduleinfo */
  OPT_fmodules = 1367,                       /* -fmodules */
  ...
  OPT_fname_mangling_version_ = 1377,        /* -fname-mangling-version- */
  OPT_fnew_abi = 1378,                       /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 1379,          /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 1380,              /* -fnew-ttp-matching */
  OPT_fnext_runtime = 1381,                  /* -fnext-runtime */
  OPT_fnil = 1382,                           /* -fnil */
  OPT_fnil_receivers = 1383,                 /* -fnil-receivers */
  OPT_fno_m2_plugin = 1384,                  /* -fno-m2-plugin */
  OPT_fno_modules = 1385,                    /* -fno-modules */
  OPT_fno_pthread = 1386,                    /* -fno-pthread */
  ...
  OPT_fobject_path_ = 1399,                  /* -fobject-path= */
  ...
  OPT_fpie = 1432,                           /* -fpie */
  OPT_fpim = 1433,                           /* -fpim */
  OPT_fpim2 = 1434,                          /* -fpim2 */
  OPT_fpim3 = 1435,                          /* -fpim3 */
  OPT_fpim4 = 1436,                          /* -fpim4 */
  OPT_fplan9_extensions = 1437,              /* -fplan9-extensions */
  OPT_fplt = 1438,                           /* -fplt */
  OPT_fplugin_arg_ = 1439,                   /* -fplugin-arg- */
  OPT_fplugin_ = 1440,                       /* -fplugin= */
  OPT_fpositive_mod_floor_div = 1441,        /* -fpositive-mod-floor-div */
  ...
  OPT_fpreview_dip1000 = 1452,               /* -fpreview=dip1000 */
  OPT_fpreview_dip1008 = 1453,               /* -fpreview=dip1008 */
  OPT_fpreview_dip1021 = 1454,               /* -fpreview=dip1021 */
  OPT_fpreview_dip25 = 1455,                 /* -fpreview=dip25 */
  OPT_fpreview_dtorfields = 1456,            /* -fpreview=dtorfields */
  OPT_fpreview_fieldwise = 1457,             /* -fpreview=fieldwise */
  OPT_fpreview_fixaliasthis = 1458,          /* -fpreview=fixaliasthis */
  OPT_fpreview_in = 1459,                    /* -fpreview=in */
  OPT_fpreview_inclusiveincontracts = 1460,  /* -fpreview=inclusiveincontracts */
  OPT_fpreview_nosharedaccess = 1461,        /* -fpreview=nosharedaccess */
  OPT_fpreview_rvaluerefparam = 1462,        /* -fpreview=rvaluerefparam */
  OPT_fpreview_shortenedmethods = 1463,      /* -fpreview=shortenedmethods */
  OPT_fprintf_return_value = 1464,           /* -fprintf-return-value */
  OPT_fprofile = 1465,                       /* -fprofile */
  OPT_fprofile_abs_path = 1466,              /* -fprofile-abs-path */
  OPT_fprofile_arcs = 1467,                  /* -fprofile-arcs */
  OPT_fprofile_correction = 1468,            /* -fprofile-correction */
  OPT_fprofile_dir_ = 1469,                  /* -fprofile-dir= */
  OPT_fprofile_exclude_files_ = 1470,        /* -fprofile-exclude-files= */
  OPT_fprofile_filter_files_ = 1471,         /* -fprofile-filter-files= */
  OPT_fprofile_generate = 1472,              /* -fprofile-generate */
  OPT_fprofile_generate_ = 1473,             /* -fprofile-generate= */
  OPT_fprofile_info_section = 1474,          /* -fprofile-info-section */
  OPT_fprofile_info_section_ = 1475,         /* -fprofile-info-section= */
  OPT_fprofile_note_ = 1476,                 /* -fprofile-note= */
  OPT_fprofile_partial_training = 1477,      /* -fprofile-partial-training */
  OPT_fprofile_prefix_map_ = 1478,           /* -fprofile-prefix-map= */
  OPT_fprofile_prefix_path_ = 1479,          /* -fprofile-prefix-path= */
  OPT_fprofile_reorder_functions = 1480,     /* -fprofile-reorder-functions */
  OPT_fprofile_report = 1481,                /* -fprofile-report */
  OPT_fprofile_reproducible_ = 1482,         /* -fprofile-reproducible= */
  OPT_fprofile_update_ = 1483,               /* -fprofile-update= */
  OPT_fprofile_use = 1484,                   /* -fprofile-use */
  OPT_fprofile_use_ = 1485,                  /* -fprofile-use= */
  OPT_fprofile_values = 1486,                /* -fprofile-values */
  OPT_fprotect_parens = 1487,                /* -fprotect-parens */
  OPT_fq = 1488,                             /* -fq */
  OPT_frandom_seed = 1489,                   /* -frandom-seed */
  OPT_frandom_seed_ = 1490,                  /* -frandom-seed= */
  OPT_frange = 1491,                         /* -frange */
  ...
  OPT_freturn = 1523,                        /* -freturn */
  OPT_frevert_all = 1524,                    /* -frevert=all */
  OPT_frevert_dip1000 = 1525,                /* -frevert=dip1000 */
  OPT_frevert_dip25 = 1526,                  /* -frevert=dip25 */
  OPT_frevert_dtorfields = 1527,             /* -frevert=dtorfields */
  OPT_frevert_intpromote = 1528,             /* -frevert=intpromote */
  OPT_frevert_markdown = 1529,               /* -frevert=markdown */
  OPT_frounding_math = 1530,                 /* -frounding-math */
  OPT_frtti = 1531,                          /* -frtti */
  OPT_fruntime_modules_ = 1532,              /* -fruntime-modules= */
  ...
  OPT_fsanitize_undefined_trap_on_error = 1538,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 1539,                     /* -fsanitize= */
  OPT_fsave_mixins_ = 1540,                  /* -fsave-mixins= */
  OPT_fsave_optimization_record = 1541,      /* -fsave-optimization-record */
  OPT_fsched_critical_path_heuristic = 1542, /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 1543,     /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 1544,         /* -fsched-group-heuristic */
  OPT_fsched_interblock = 1545,              /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 1546,     /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 1547,                /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 1548,          /* -fsched-rank-heuristic */
  OPT_fsched_spec = 1549,                    /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 1550,     /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 1551,               /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 1552,     /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 1553,           /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 1554,       /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 1555,      /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 1556,          /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 1557,                /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 1558,        /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 1559, */       /* -fsched2-use-traces */
  OPT_fschedule_fusion = 1560,               /* -fschedule-fusion */
  OPT_fschedule_insns = 1561,                /* -fschedule-insns */
  OPT_fschedule_insns2 = 1562,               /* -fschedule-insns2 */
  OPT_fsecond_underscore = 1563,             /* -fsecond-underscore */
  OPT_fsection_anchors = 1564,               /* -fsection-anchors */
  /* OPT_fsee = 1565, */                     /* -fsee */
  OPT_fsel_sched_pipelining = 1566,          /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 1567,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 1568,/* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 1569,          /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 1570,         /* -fselective-scheduling2 */
  OPT_fself_test_ = 1571,                    /* -fself-test= */
  OPT_fsemantic_interposition = 1572,        /* -fsemantic-interposition */
  OPT_fshared = 1573,                        /* -fshared */
  ...
  OPT_fsoft_check_all = 1587,                /* -fsoft-check-all */
  OPT_fsources = 1588,                       /* -fsources */
  OPT_fsplit_ivs_in_unroller = 1589,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1590,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1591,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1592,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1593,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1594,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1595,                      /* -fsquangle */
  OPT_fssa_backprop = 1596,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1597,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1598,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1599,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1600, */             /* -fstack-check */
  OPT_fstack_check_ = 1601,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1602,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1603,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1604,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1605,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1606,               /* -fstack-protector */
  OPT_fstack_protector_all = 1607,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1608,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1609,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1610,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1611,                   /* -fstack-usage */
  OPT_fstats = 1612,                         /* -fstats */
  OPT_fstdarg_opt = 1613,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1614,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1615, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1616,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1617,                  /* -fstrict-enums */
  ...
  OPT_ftarget_ar_ = 1630,                    /* -ftarget-ar= */
  /* OPT_ftarget_help = 1631, */             /* -ftarget-help */
  OPT_ftarget_ranlib_ = 1632,                /* -ftarget-ranlib= */
  OPT_ftemplate_backtrace_limit_ = 1633,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1634, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1635,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1636,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1637,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1638,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1639,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1640,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1641,                   /* -ftime-report */
  OPT_ftime_report_details = 1642,           /* -ftime-report-details */
  OPT_ftls_model_ = 1643,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1644,              /* -ftoplevel-reorder */
  OPT_ftracer = 1645,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1646,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1647,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1648,                   /* -ftrampolines */
  OPT_ftransition_all = 1649,                /* -ftransition=all */
  OPT_ftransition_field = 1650,              /* -ftransition=field */
  OPT_ftransition_in = 1651,                 /* -ftransition=in */
  OPT_ftransition_nogc = 1652,               /* -ftransition=nogc */
  OPT_ftransition_templates = 1653,          /* -ftransition=templates */
  OPT_ftransition_tls = 1654,                /* -ftransition=tls */
  OPT_ftransition_vmarkdown = 1655,          /* -ftransition=vmarkdown */
  ...
  OPT_funbounded_by_reference = 1704,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 1705,         /* -funconstrained-commons */
  OPT_funderscoring = 1706,                  /* -funderscoring */
  OPT_funit_at_a_time = 1707,                /* -funit-at-a-time */
  OPT_funittest = 1708,                      /* -funittest */
  ...
  OPT_fuselist = 1725,                       /* -fuselist */
  OPT_fvar_tracking = 1726,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1727,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1728,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1729,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1730,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1731, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1732,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1733,                   /* -fverbose-asm */
  /* OPT_fversion = 1734, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1735,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1736,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1737,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1738,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1739,                   /* -fvisibility= */
  OPT_fvpt = 1740,                           /* -fvpt */
  OPT_fvtable_gc = 1741,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1742,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1743,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1744,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1745,                     /* -fvtv-debug */
  OPT_fweak = 1746,                          /* -fweak */
  OPT_fweak_templates = 1747,                /* -fweak-templates */
  OPT_fweb = 1748,                           /* -fweb */
  /* OPT_fwhole_file = 1749, */              /* -fwhole-file */
  OPT_fwhole_program = 1750,                 /* -fwhole-program */
  OPT_fwholediv = 1751,                      /* -fwholediv */
  OPT_fwholevalue = 1752,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 1753,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1754,             /* -fworking-directory */
  OPT_fwpa = 1755,                           /* -fwpa */
  OPT_fwpa_ = 1756,                          /* -fwpa= */
  OPT_fwrapv = 1757,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1758,                 /* -fwrapv-pointer */
  OPT_fxcode = 1759,                         /* -fxcode */
  OPT_fxref = 1760,                          /* -fxref */
  /* OPT_fzee = 1761, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 1762,          /* -fzero-call-used-regs= */
  OPT_fzero_initialized_in_bss = 1763,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1764,                     /* -fzero-link */
  OPT_g = 1765,                              /* -g */
  OPT_gant = 1766,                           /* -gant */
  OPT_gas_loc_support = 1767,                /* -gas-loc-support */
  OPT_gas_locview_support = 1768,            /* -gas-locview-support */
  OPT_gbtf = 1769,                           /* -gbtf */
  OPT_gcoff = 1770,                          /* -gcoff */
  OPT_gcoff1 = 1771,                         /* -gcoff1 */
  OPT_gcoff2 = 1772,                         /* -gcoff2 */
  OPT_gcoff3 = 1773,                         /* -gcoff3 */
  OPT_gcolumn_info = 1774,                   /* -gcolumn-info */
  OPT_gctf = 1775,                           /* -gctf */
  OPT_gdescribe_dies = 1776,                 /* -gdescribe-dies */
  OPT_gdwarf = 1777,                         /* -gdwarf */
  OPT_gdwarf_ = 1778,                        /* -gdwarf- */
  OPT_gdwarf32 = 1779,                       /* -gdwarf32 */
  OPT_gdwarf64 = 1780,                       /* -gdwarf64 */
  OPT_gen_decls = 1781,                      /* -gen-decls */
  OPT_ggdb = 1782,                           /* -ggdb */
  OPT_ggnu_pubnames = 1783,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1784,                   /* -gimple-stats */
  OPT_ginline_points = 1785,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1786, /* -ginternal-reset-location-views */
  OPT_gnat = 1787,                           /* -gnat */
  OPT_gnatO = 1788,                          /* -gnatO */
  OPT_gno_ = 1789,                           /* -gno- */
  OPT_gno_pubnames = 1790,                   /* -gno-pubnames */
  OPT_gpubnames = 1791,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1792,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1793,                   /* -gsplit-dwarf */
  OPT_gstabs = 1794,                         /* -gstabs */
  OPT_gstabs_ = 1795,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1796,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1797,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1798,                        /* -gtoggle */
  OPT_gvariable_location_views = 1799,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1800,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1801,                           /* -gvms */
  OPT_gxcoff = 1802,                         /* -gxcoff */
  OPT_gxcoff_ = 1803,                        /* -gxcoff+ */
  OPT_gz = 1804,                             /* -gz */
  OPT_gz_ = 1805,                            /* -gz= */
  OPT_h = 1806,                              /* -h */
  OPT_help = 1807,                           /* -help */
  OPT_idirafter = 1808,                      /* -idirafter */
  OPT_imacros = 1809,                        /* -imacros */
  OPT_imultiarch = 1810,                     /* -imultiarch */
  OPT_imultilib = 1811,                      /* -imultilib */
  OPT_include = 1812,                        /* -include */
  OPT_iplugindir_ = 1813,                    /* -iplugindir= */
  OPT_iprefix = 1814,                        /* -iprefix */
  OPT_iquote = 1815,                         /* -iquote */
  OPT_isysroot = 1816,                       /* -isysroot */
  OPT_isystem = 1817,                        /* -isystem */
  OPT_iwithprefix = 1818,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1819,              /* -iwithprefixbefore */
  OPT_k8 = 1820,                             /* -k8 */
  OPT_l = 1821,                              /* -l */
  OPT_lang_asm = 1822,                       /* -lang-asm */
  OPT_list = 1823,                           /* -list */
  OPT_mabi_ = 1824,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1825,             /* -mabort-on-noreturn */
  OPT_mandroid = 1826,                       /* -mandroid */
  OPT_mapcs = 1827,                          /* -mapcs */
  OPT_mapcs_frame = 1828,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1829,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1830,              /* -mapcs-stack-check */
  OPT_march_ = 1831,                         /* -march= */
  OPT_marm = 1832,                           /* -marm */
  OPT_masm_syntax_unified = 1833,            /* -masm-syntax-unified */
  OPT_mbe32 = 1834,                          /* -mbe32 */
  OPT_mbe8 = 1835,                           /* -mbe8 */
  OPT_mbig_endian = 1836,                    /* -mbig-endian */
  OPT_mbionic = 1837,                        /* -mbionic */
  OPT_mbranch_cost_ = 1838,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1839,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1840,     /* -mcaller-super-interworking */
  OPT_mcmse = 1841,                          /* -mcmse */
  OPT_mcpu_ = 1842,                          /* -mcpu= */
  OPT_mfdpic = 1843,                         /* -mfdpic */
  OPT_mfix_cmse_cve_2021_35465 = 1844,       /* -mfix-cmse-cve-2021-35465 */
  OPT_mfix_cortex_a57_aes_1742098 = 1845,    /* -mfix-cortex-a57-aes-1742098 */
  /* OPT_mfix_cortex_a72_aes_1655431 = 1846, *//* -mfix-cortex-a72-aes-1655431 */
  OPT_mfix_cortex_m3_ldrd = 1847,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1848,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1849,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1850,                  /* -mfp16-format= */
  OPT_mfpu_ = 1851,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1852,             /* -mgeneral-regs-only */
  OPT_mglibc = 1853,                         /* -mglibc */
  /* OPT_mhard_float = 1854, */              /* -mhard-float */
  OPT_mlibarch_ = 1855,                      /* -mlibarch= */
  OPT_mlittle_endian = 1856,                 /* -mlittle-endian */
  OPT_mlong_calls = 1857,                    /* -mlong-calls */
  OPT_mmusl = 1858,                          /* -mmusl */
  OPT_mneon_for_64bits = 1859,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1860,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1861,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1862,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1863,               /* -mprint-tune-info */
  OPT_mpure_code = 1864,                     /* -mpure-code */
  OPT_mrestrict_it = 1865,                   /* -mrestrict-it */
  OPT_msched_prolog = 1866,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1867,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1868,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1869, */              /* -msoft-float */
  OPT_mstack_protector_guard_offset_ = 1870, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_ = 1871,        /* -mstack-protector-guard= */
  OPT_mstructure_size_boundary_ = 1872,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1873,                         /* -mthumb */
  OPT_mthumb_interwork = 1874,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1875,                  /* -mtls-dialect= */
  OPT_mtp_ = 1876,                           /* -mtp= */
  OPT_mtpcs_frame = 1877,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1878,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1879,                         /* -mtune= */
  OPT_muclibc = 1880,                        /* -muclibc */
  OPT_munaligned_access = 1881,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1882,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1883,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1884,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1885,              /* -mword-relocations */
  OPT_n = 1886,                              /* -n */
  ...
  OPT_nocpp = 1891,                          /* -nocpp */
  OPT_nodefaultlibs = 1892,                  /* -nodefaultlibs */
  OPT_nolibc = 1893,                         /* -nolibc */
  OPT_nophoboslib = 1894,                    /* -nophoboslib */
  OPT_nostartfiles = 1895,                   /* -nostartfiles */
  OPT_nostdinc = 1896,                       /* -nostdinc */
  OPT_nostdinc__ = 1897,                     /* -nostdinc++ */
  OPT_nostdlib = 1898,                       /* -nostdlib */
  OPT_o = 1899,                              /* -o */
  OPT_objects = 1900,                        /* -objects */
  OPT_p = 1901,                              /* -p */
  OPT_pass_exit_codes = 1902,                /* -pass-exit-codes */
  /* OPT_pedantic = 1903, */                 /* -pedantic */
  OPT_pedantic_errors = 1904,                /* -pedantic-errors */
  OPT_pg = 1905,                             /* -pg */
  OPT_pie = 1906,                            /* -pie */
  OPT_pipe = 1907,                           /* -pipe */
  OPT_posix = 1908,                          /* -posix */
  OPT_print_file_name_ = 1909,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1910,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1911,          /* -print-multi-directory */
  OPT_print_multi_lib = 1912,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1913,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1914,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1915,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1916,               /* -print-prog-name= */
  OPT_print_search_dirs = 1917,              /* -print-search-dirs */
  OPT_print_sysroot = 1918,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1919,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1920,                    /* -print-value */
  OPT_profile = 1921,                        /* -profile */
  OPT_pthread = 1922,                        /* -pthread */
  OPT_quiet = 1923,                          /* -quiet */
  OPT_r = 1924,                              /* -r */
  OPT_rdynamic = 1925,                       /* -rdynamic */
  ...
  OPT_time = 2011,                           /* -time */
  OPT_time_ = 2012,                          /* -time= */
  OPT_tno_android_cc = 2013,                 /* -tno-android-cc */
  OPT_tno_android_ld = 2014,                 /* -tno-android-ld */
